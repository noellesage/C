...
{
  struct Link* curr = list->sentinel;
  while(curr->next != curr) {
    struct Link* prev = curr;
    curr = curr->next;
    removeLink(list, prev);
  }
...
void circularListRemoveFront(struct CircularList* list)
{
  ...
  list->sentinel->next = curr->next;
  curr->next->prev = list->sentinel;
  removeLink(list, curr);
}
...
void circularListRemoveBack(struct CircularList* list)
{
  ...
  list->sentinel->prev = curr->prev;
  curr->prev->next = list->sentinel;
  removeLink(list, curr);
}
